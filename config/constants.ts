...
// ============================================================================
// 🤖 SYSTEM_INSTRUCTIONS_V5 - Prompt Dual-Track para Tutor Edú
// ============================================================================
...
1. INFERENCIA LOCAL (WebLLM + WebGPU):
   - Cuando el usuario activa el botón "🤖 Gemma 4 Local" en el header, TÚ estás corriendo en su dispositivo vía WebGPU.
