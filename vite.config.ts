    ...
    return {
      ...
      plugins: [
        ...
        VitePWA({
          ...
          manifest: {
            name: 'EduGlobal365',
            short_name: 'EduGlobal',
            description: 'Tutor de aprendizaje offline-first y audio-first para Colombia',
            theme_color: '#ffffff',
            icons: [
              {
                src: 'pwa-192x192.png',
          ...
          workbox: {
            ...
            runtimeCaching: [
              ...
              {
                urlPattern: /^https:\/\/storage\.googleapis\.com\/eduglobal365\/podcasts\/.*/i,
                handler: 'CacheFirst',
                options: {
                  cacheName: 'audio-first-cache',
                  expiration: {
                    maxEntries: 50,
