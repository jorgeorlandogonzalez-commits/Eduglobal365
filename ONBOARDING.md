...
¡Bienvenido a **EduGlobal365**! Este documento es tu guía de inicio rápido para operar, probar y dominar la plataforma educativa más avanzada para el contexto de Colombia, impulsada por tecnología Offline-First, IA Local (WebLLM) y un robusto enfoque de Arquitectura Dual-Track.
...
- **Herramienta estrella**: Botón **"Preparar para la Vereda"** (Exporta toda tu clase en un archivo HTML que funciona 100% offline).
...
2. Entra a una materia (Ej: Matemáticas).
...
### 3. Descarga de Clases (Smart Download)
1. Dentro del chat de cualquier materia, haz clic en el botón **"Preparar para la Vereda 📥"**.
2. Se descargará un archivo `.html`.
3. Abre ese archivo en una nueva pestaña (incluso estando sin internet). Verás cómo la clase, tu historial y el formato están perfectamente conservados gracias a la inyección de Service Workers en el archivo generado.

### 4. Simulación Ping-Pong (Audio-First)
1. Selecciona el módulo de la biblioteca con DBA cargados (Ej. Trigonometría Agrícola).
2. "Simula" reproducir el audio. A los 10 segundos, el sistema debe disparar un [RETO_VEREDA] automático en el chat, pausando la clase teórica para forzarte a practicar.
